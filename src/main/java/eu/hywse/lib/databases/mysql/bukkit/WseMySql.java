...
public class WseMySql extends WseMySqlWrapper {
  ...
  public WseMySql(JavaPlugin plugin, String host, String database, String user, String password,
      int port) {
    super(plugin.getDescription().getName(), host, database, user, password, port);
    this.plugin = plugin;
  }

  public WseMySql(JavaPlugin plugin, String sqlInfoFile, String database)
