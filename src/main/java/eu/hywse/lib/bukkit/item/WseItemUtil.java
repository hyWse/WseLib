...
import static eu.hywse.lib.bukkit.WseTextUtil.nc;
import static eu.hywse.lib.bukkit.WseTextUtil.ncc;
...
public class WseItemUtil {
  ...
  public static void updateItemInfo(ItemStack item, String key, String value) {
    ...
    final List<String> lore = item.getItemMeta().hasLore() && item.getItemMeta().getLore() != null
  ...
  public static void deleteInfo(ItemStack stack, String key) {
    ...
    List<String> lore =
        stack.getItemMeta().hasLore() ? stack.getItemMeta().getLore() : new ArrayList();
