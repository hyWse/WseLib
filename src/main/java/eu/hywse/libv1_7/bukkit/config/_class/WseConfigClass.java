package eu.hywse.libv1_7.bukkit.config._class;

import eu.hywse.libv1_7.bukkit.WseLocation;
import eu.hywse.libv1_7.bukkit.WseSerialize;
import eu.hywse.libv1_7.bukkit.config.WseConfig;
